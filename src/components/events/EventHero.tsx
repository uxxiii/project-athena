        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Button href="#register" size="lg" className="bg-gold text-purple-deep font-semibold hover:bg-gold-light">
                <span>Registration Opening Soon</span>
                <ArrowDown size={16} />
              </Button>
            ...
            <div className="rounded-3xl glass-card p-6 shadow-2xl space-y-5 relative overflow-hidden">
              ...
              <div className="space-y-1">
                <p className="text-xs text-cream/70 font-sans">
                  Delegate registrations are <strong className="text-gold font-mono font-medium">opening soon</strong>! Portfolios will be allocated on a first-come basis upon launch.
                </p>
              </div>
